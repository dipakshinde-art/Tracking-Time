...
import { Box, Image, Text, Input, Button, Grid, Menu, MenuButton, MenuList, MenuItem, useDisclosure,Accordion,
    AccordionItem,
    AccordionButton,
    AccordionPanel,
        ...
        <div  >
            ...
            <Box className={css.box}>
                <Box className={css.box1}>
                    <Image w="71px" h="84px" src='https://trackingtime.co/wp-content/themes/trackingtime-v4/img/layout/footer/tt.svg' />
                    <Text fontSize="35px" fontWeight="700">Get Started</Text>
                    <Text fontWeight="600" color="#7F8488">Sign up today and join thousands of people around the world using TrackingTime to make the most of their time.</Text>
                        ...
                        <Box>
                            ...
                            <Menu isOpen={isOpen}>
                                ...
                                <MenuList onMouseEnter={onOpen} onMouseLeave={onClose} >
                                    <MenuItem><h1>DEUTSCH</h1></MenuItem>
                                    <MenuItem><h1>ESPAÑOL</h1></MenuItem>
                                    <MenuItem><h1>PORTUGUÊS</h1></MenuItem>
                                </MenuList>
                            </Menu>
                        </Box>
                    </Grid>
