...
import { getTaskApi, othersTaskApi, personalTaskApi, professionalTaskApi } from "../taskreducer/action";

const List = () => {

  let { tasks, Personal_task,Professional_task,Others_task, filter } = useSelector((state) => state.task);
  if (filter) {
  ...
  }, [tasks.length, Personal_task.length,Professional_task.length,Others_task.length]);
